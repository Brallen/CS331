...
int main(int argc, char** argv){
   ...
   vector<State> path = bfs(initial,goal);
...
vector<State> bfs(State start, State goal)
{
   ...
   while(!elems.empty() && depth < 100){ //while elements are still in queue keep going
	 ...
	 if(i == 0){ //move one chicken
	    ...
	    bool good = moveAnimals(test, &next, 1, 0); //move animals around
	    // cout << "good: " << good << endl;
	    // cout << "is valid: " << isValid(next) << endl;
	    if(good == true  && isValid(next)){ //see if this is a valid move (needs help)
	       // cout << "good elem" << endl;
	       elems.push(next); //if good add it to the queue to check later
	    }
	    // cout << endl;
	 }
	 else if(i == 1){ //move two chickens
	    State next; //make a new state for the next move
	    bool good = moveAnimals(test, &next, 2, 0); //move animals around
	    // cout << "good: " << good << endl;
	    // cout << "is valid: " << isValid(next) << endl;
	    if(good == true  && isValid(next)){ //see if this is a valid move (needs help)
	       // cout << "good elem" << endl;
	 ...
	 else if(i == 2){ //move one wolf
	    State next; //make a new state for the next move
	    bool good = moveAnimals(test, &next, 0, 1); //move animals around
	    // cout << "good: " << good << endl;
	    // cout << "is valid: " << isValid(next) << endl;
	    if(good == true  && isValid(next)){ //see if this is a valid move (needs help)
	       // cout << "good elem" << endl;
	 ...
	 else if(i == 3){ //move one chicken and one wolf
	    State next; //make a new state for the next move
	    bool good = moveAnimals(test, &next, 1, 1); //move animals around
	    // cout << "good: " << good << endl;
	    // cout << "is valid: " << isValid(next) << endl;
	    if(good == true  && isValid(next)){ //see if this is a valid move (needs help)
	       // cout << "good elem" << endl;
	 ...
	 else if(i == 4){ //move two wolves
	    State next; //make a new state for the next move
	    bool good = moveAnimals(test, &next, 0, 2); //move animals around
	    // cout << "good: " << good << endl;
	    //cout << "is valid: " << isValid(next) << endl;
	    if(good == true  && isValid(next)){ //see if this is a valid move (needs help)
	      // cout << "good elem" << endl;
